with curated(slug, name, description, category, line, gender, image_url, image_hover_url) as (
  ...
  (
    ...
    'Zip Hoodie Forest Green',
    'Áo hoodie zip màu xanh rêu, form rộng, hợp phối quần cargo và sneaker sáng màu.',
    'Hoodie Oversize',
    'Urbas Inspired',
    'nam',
  ...
  (
    ...
    'https://images.unsplash.com/photo-1506629905607-d9f297d5f5f7?auto=format&fit=crop&w=1200&q=80'
  ),
  (
    'cargo-shorts-black',
    'Cargo Shorts Black',
    ...
    'Cargo Utility',
    'nam',
    'https://images.unsplash.com/photo-1506629905607-d9f297d5f5f7?auto=format&fit=crop&w=900&q=80',
